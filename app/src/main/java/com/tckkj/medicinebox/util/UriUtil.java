...
//    public static String ip = "http://192.168.0.140:8080/MedicineBox/";
    ...
    public static String getNewUserMessage = ip + "action/baseUser/getNewUserMessage";//App7/根据token获取最新账户信息 >
    public static String getHostListByNumber = ip + "action/baseHost/getHostByNumber";//App8/根据主机编号搜索主机列表 >
    public static String connectHost = ip + "action/baseHost/connectHost";//App9/连接主机 >
    public static String getHostMessage = ip + "action/baseHost/getHostMessage";//App10/查看主机详情 >
    ...
    public static String updateMedicineStorehouse = ip + "action/baseMedicineStorehouse/updateMedicineStorehouse";//App17/药仓新增、添加或更换药品 >
    public static String deleteStorehouseData = ip + "action/baseMedicineStorehouse/deleteStorehouseData";//App18/药仓清空数据 >
    ...
    public static String getStorehouseData = ip + "action/baseHost/getStorehouseData";//App21/根据主机号及药仓序号获取药仓数据 >
